...
function loadImages() {
    ...
    if(is_dir($useruploadpath)){
        ...
        for($i=count($files)-1; $i >= 0; $i--):
            ...
            $image_fullname = $image_pathinfo['filename'].".".$image_pathinfo['extension'];;
            ...
            if($file_style == "block") { ?>
                <div class="fileDiv"
                     onclick="showEditBar('<?php echo $pic_url.$image_fullname; ?>','<?php echo $image_height; ?>','<?php echo $count; ?>','<?php echo $image; ?>');"
                     ondblclick="showImage('<?php echo $pic_url.$image_fullname; ?>','<?php echo $image_height; ?>','<?php echo $image; ?>');"
