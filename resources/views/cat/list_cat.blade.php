            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-warning mt-2 mt-xl-0 text-right add-store"><i class="fa fa-archive"></i>  {!! trans('messages.category.title') !!}</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('click','.view-store',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/cat/view',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.edit-store',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/cat/edit',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/employee/cat/delete", {
                                id: id
                            }, function(e) {
