            ...
            <div class="card">
                <div class="card-body">
                    <div class="panel-heading">
                        <h3 class="panel-title">{!! trans('messages.driver.driver') !!}</h3>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-primary mt-2 mt-xl-0 text-right add-store"><i class="fa fa-archive"></i>  {!! trans('messages.driver.driver') !!}</button>
                        ...
                        <div class="panel-body" id="landing-subject-list">
                            @include('driver.list_driver_element')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <h4 class="modal-title" style="color: #bbbfc3;">{!! trans('messages.driver.driver') !!}</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form">
                                {!! Form::model(null,array('url' => array('employee/driver/add'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.search-store').on('click',function(){
                ...
                $.ajax({
                    url : $('#root-url').val()+'/employee/driver/list',
                    method : 'post',
                    dataType : 'html',
                    data : data,
                    success : function(e){
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/employee/driver/list';
            });
            ...
            $('body').on('click','.view-store',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/driver/view',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.edit-store',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/driver/edit',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/employee/driver/delete", {
                                id: id
                            }, function(e) {
                                swal("Poof! Your imaginary file has been deleted!", {
                                    icon: "success",
                                }).then(function(){
                                    window.location.href ='/employee/driver/list'
                                });
                            });
                        }, 50);
                    } else {
