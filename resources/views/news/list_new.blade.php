            ...
            <div class="card">
                <div class="card-body">
                    <div class="panel-heading">
                        <h3 class="panel-title">{!! trans('messages.news.title') !!}</h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row w3-hide-small">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-warning mt-2 mt-xl-0 text-right add-store"><i class="fa fa-newspaper-o"></i>  {!! trans('messages.news.title') !!}</button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <h4 class="modal-title" style="color: #bbbfc3;">{!! trans('messages.news.title') !!}</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form">
                                {!! Form::model(null,array('url' => array('employee/news/add'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
        ...
        $(document).ready(function() {
            ...
            function propertyPage (page) {
                // $('.search-store').on('click', function () {
                    ...
                    $.ajax({
                        url: $('#root-url').val() + '/customer/news',
                        method: 'post',
                        dataType: 'html',
                        data: data,
                        success: function (e) {
