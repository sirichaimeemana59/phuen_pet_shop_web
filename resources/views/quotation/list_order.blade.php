            ...
            <div class="card">
                <div class="card-body">
                    <div class="panel-heading">
                        <h3 class="panel-title">{!! trans('messages.quotation.title') !!}</h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row w3-hide-small">
                            <div class="col-sm-12 text-right">
                                <a href="{!! url('employee/create/quotation') !!}"><button class="btn btn-primary mt-2 mt-xl-0 text-right"><i class="fa fa-archive"></i>  {!! trans('messages.quotation.title') !!}</button></a>
                            </div>
                        </div>
                        <br>
                        <div class="panel-body" id="landing-subject-list">
                            @include('quotation.list_order_element')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <h4 class="modal-title" style="color: #bbbfc3;">{!! trans('messages.quotation.title') !!}</h4>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post("/employee/quotation/delete", {
                                id: id
                            }, function(e) {
