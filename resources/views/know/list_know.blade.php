                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row w3-hide-small">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-warning mt-2 mt-xl-0 text-right add-store"><i class="fa fa-archive"></i>  {!! trans('messages.know.title') !!}</button>
        ...
        $(document).ready(function() {
            ...
            function propertyPage (page) {
                ...
                // $('.search-store').on('click', function () {
                    ...
                    $.ajax({
                        url: $('#root-url').val() + '/employee/list/know',
                        method: 'post',
                        dataType: 'html',
                        data: data,
                        success: function (e) {
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/employee/list/know';
            });
            ...
            $('body').on('click','.view-store',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/know/view',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.edit-store',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/know/edit',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/employee/know/delete", {
                                id: id
                            }, function(e) {
