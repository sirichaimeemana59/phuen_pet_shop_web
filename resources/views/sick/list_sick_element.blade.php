@if($p_row->count() > 0)
    ...
    <table cellspacing="0" class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th>{!! trans('messages.analyze.name') !!}</th>
            ...
            @foreach($p_row as $key => $row)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{!! url('employee/sick/edit/'.$row->id) !!}"><button class="btn btn-warning mt-2 mt-xl-0 text-right"><i class="mdi mdi-tooltip-edit"></i></button></a>
