                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="panel-body" id="landing-subject-list">
                            {!! Form::model($order,array('url' => array('/employee/update/expenditure/order_company'),'class'=>'form-horizontal form_add create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
                            <div class="form-group row">
                                <input type="hidden" name="id_order" value="{!! $order->id !!}" class="id_order">
                                <input type="hidden" name="order_code" value="{!! $order->code !!}" class="order_code">
                                    ...
                                    <div class="panel-body" id="landing-subject-list">
                                        <table class="table itemTables" style="width: 100%">
                                            ...
                                            @foreach($order_ as $key => $t)
                                                <tr>
                                                    <input type="hidden" class="form-control" name="data_[{!! $key !!}][id]" value="{!! $t['id'] !!}">
                                                    {{--<td><input type="text" class="form-control" name="data_[{!! $key !!}][amount]" value="{!! $t->amount !!}"></td>--}}
                                                    @if($t['name'] != null)
                                                        <td><input type="text" class="form-control" name="data_[{!! $key !!}][product_name]" value="{!! $t['name'] !!}" readonly></td>
                                                        <td><input type="text" class="form-control num" name="data_[{!! $key !!}][amount]" value="{!! $t['amount'] !!}" readonly></td>
                                                        <td><input type="text" class="form-control" name="data_[{!! $key !!}][unit_name]" value="{!! $t['unit_name'] !!}" readonly></td>
                                                    @else
                                                     <td>
                                                         <select name="data_[{!! $key !!}][product_id]" id="" class="form-control" disabled>
                                                        ...
                                                        <td><input type="text" class="form-control num" name="data_[{!! $key !!}][amount]" value="{!! $t->amount !!}" readonly></td>
                                                        <td>
                                                            <select name="data_[{!! $key !!}][unit]" id="" class="form-control" disabled>
                                                    ...
                                                    {{--@else--}}
                                                        ...
                                                        {{--</td>--}}
                                                    {{--@endif--}}
                                                    <td><input type="text" class="form-control num" name="data_[{!! $key !!}][price]" required></td>
                                                </tr>
                                            @endforeach
                                        </table>
                                    </div>
                ...
                <div class="card-body float-right">
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="panel-body float-right" id="landing-subject-list">
                            <div class="form-group row">
                                <lable class="col-sm-4 control-label">{!! trans('messages.product.total') !!}</lable>
                                <div class="col-sm-2">
                                </div>

                                <lable class="col-sm-2 control-label"></lable>
                                <div class="col-sm-10">
                                    {!! Form::text('total_all',null,array('class'=>'form-control num','placeholder'=>trans('messages.product.total'),'required')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
