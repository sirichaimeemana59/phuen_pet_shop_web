                ...
                <div class="card-body">
                    ...
                    <div class="panel-body search-form">
                        <form method="POST" id="search-form" action="#" accept-charset="UTF-8" class="form-horizontal">
                            <div class="row">
                                <lable class="col-sm-2 control-label">{!! trans('messages.expenditure.title') !!}</lable>
                                <div class="col-sm-4">
                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        ...
                        <div class="panel-body" id="landing-subject-list">
                            @include('expenditure.list_expenditure_element')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.search-store').on('click',function(){
                ...
                $.ajax({
                    url : $('#root-url').val()+'/employee/list_expenditure',
                    method : 'post',
                    dataType : 'html',
                    data : data,
                    success : function(e){
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/employee/list_expenditure';
            });
