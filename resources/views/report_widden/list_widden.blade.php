            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                    <a href="{!! url('employee/widen/stock') !!}"><button class="btn btn-warning mt-2 mt-xl-0 text-right"><i class="fa fa-archive"></i>  {!! trans('messages.widen.title') !!}</button></a>
                            </div>
                        </div>
                        <br>
                        <div class="panel-body" id="landing-subject-list">
                            @include('report_widden.list_widden_element')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.search-store').on('click',function(){
                ...
                $.ajax({
                    url : $('#root-url').val()+'/widen/list_element',
                    method : 'post',
                    dataType : 'html',
                    data : data,
                    success : function(e){
