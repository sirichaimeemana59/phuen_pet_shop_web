    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.province').on('change',function(){
                ...
                id = $(this).val();
                $.ajax({
                    url : "/address/select/district/address",
                    method : 'post',
                    dataType: 'html',
                    data : ({'id':id}),
                    success: function (e) {
            ...
            function SelectDistrict(id){
                ...
                //console.log(id);
                $.ajax({
                    url : "/root/admin/select/subdistrict/address",
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').ready(function(){
                ...
                //console.log(dis);
                $.ajax({
                    url : "/address/select/district/edit/address",
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
                ...
                ////////////////////////////////
                $.ajax({
                    url : "/customer/select/editSubDis/address",
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('.district').on('change',function(){
                ...
                console.log(id);
                $.ajax({
                    url : "/customer/select/subdistrict/address",
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('.subdistricts').on('change',function(){
                ...
                //console.log(id);
                $.ajax({
                    url : "/customer/select/zip_code/address",
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.delete-order',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post("/employee/delete_order", {
                                id: id
                            }, function(e) {
                                swal("Poof! Your imaginary file has been deleted!", {
                                    icon: "success",
                                }).then(function(){
                                    window.location.href ='/employee/edit/order/'+order
                                });
                            });
                        }, 50);
                    } else {
