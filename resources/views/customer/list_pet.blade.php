            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-warning mt-2 mt-xl-0 text-right add-store"><i class="fa fa-archive"></i>  {!! trans('messages.pet.title') !!}</button>
                        ...
                        <div class="panel-body" id="landing-subject-list">
                            @include('customer.list_pet_element')
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form">
                                {!! Form::model(null,array('url' => array('customer/pet/add'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.search-store').on('click',function(){
                ...
                $.ajax({
                    url : $('#root-url').val()+'/customer/home',
                    method : 'post',
                    dataType : 'html',
                    data : data,
                    success : function(e){
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/customer/home';
            });
            ...
            $('.view-store').on('click',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url : $('#root-url').val()+'/customer/pet/view',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('.edit-store').on('click',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url : $('#root-url').val()+'/customer/pet/edit',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('.delete-store').on('click',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/customer/pet/delete", {
                                id: id
                            }, function(e) {
