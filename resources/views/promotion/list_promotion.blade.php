                ...
                <div class="card-body">
                    ...
                    <div class="panel panel-default" id="panel-lead-list">
                        <div class="row w3-hide-small">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-warning mt-2 mt-xl-0 text-right add-store"><i class="fa fa-archive"></i>  {!! trans('messages.promotion.title') !!}</button>
        ...
        $(document).ready(function() {
            ...
            function propertyPage (page) {
                // $('.search-store').on('click', function () {
                    ...
                    $.ajax({
                        url: $('#root-url').val() + '/employee/list/promotion',
                        method: 'post',
                        dataType: 'html',
                        data: data,
                        success: function (e) {
            ...
            $('body').on('click','.view-store',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/promotion/view',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
            ...
            $('body').on('click','.edit-store',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url : $('#root-url').val()+'/employee/promotion/edit',
                    method : 'post',
                    dataType : 'html',
                    data : ({'id':id}),
                    success : function(e){
